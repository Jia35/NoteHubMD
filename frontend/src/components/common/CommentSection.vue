    ...
    <div v-if="currentUser" class="mb-4">
      <div class="flex items-start space-x-3">
        ...
        <div class="flex-1">
          ...
          <div v-if="commentTextareaFocused || newComment.trim()" class="flex items-center gap-0.5 p-1.5 bg-gray-100 dark:bg-gray-700 rounded-t-lg border border-b-0 border-gray-300 dark:border-gray-600">
